                ...
                <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <div className="d-flex container-fluid  ">
                            <button className='btn text-light  rounded-0 mt-3 btn-lg shadow  ' data-bs-target="#exampleModalToggle" data-bs-toggle="modal" style={{ backgroundColor: "darkslateblue", width: "15rem" }}>Booked Now</button>
                        </div>
                    </div>
